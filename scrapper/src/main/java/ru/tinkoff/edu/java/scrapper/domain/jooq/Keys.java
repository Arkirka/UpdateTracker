...
public class Keys {
    ...
    public static final ForeignKey<LinkRecord, ChatRecord> CONSTRAINT_23 = Internal.createForeignKey(Link.LINK, DSL.name("CONSTRAINT_23"), new TableField[] { Link.LINK.CHAT_ID }, Keys.CONSTRAINT_1, new TableField[] { Chat.CHAT.ID }, true);
}
